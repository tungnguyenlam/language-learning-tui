...
def test_adjective_trainer_navigation():
    """Test navigating to and interacting with Adjective Ending Trainer."""
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            # Select Adjective Ending Trainer (key 4)
            agent.act('4')
            agent.wait_for_text("ADJECTIVE ENDING TRAINER", timeout=5.0)
